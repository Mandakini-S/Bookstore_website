...
const Item = (props) => {
  ...
  return (
    <div className="m-5 cursor-pointer dark:text-white">
      <Link to={`/product/${id}`}>
        <div className="transition delay-300 scale-100 hover:scale-95 dark:hover:brightness-75 border-2 border-gray-300 dark:border-gray-200 p-4 w-72 h-96 flex flex-col items-center">
          <img
          ...
          />
          <p className="text-gray-500 dark:text-black-800 max-w-80 mt-2">{name}</p>
